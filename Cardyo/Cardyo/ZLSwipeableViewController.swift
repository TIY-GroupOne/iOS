...
//        cardView.delegate = self
        ...
        if loadCardsFromXib {
            let contentView = NSBundle.mainBundle().loadNibNamed("CardyoStackView", owner: self, options: nil).first! as! UIView
            contentView.translatesAutoresizingMaskIntoConstraints = false
            contentView.backgroundColor = cardView.backgroundColor
            cardView.addSubview(contentView)
//            cardView.card = Card(term: "Rome", definition: "A nice place", deckID: "1")
